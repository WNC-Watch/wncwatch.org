...
- **Private security cameras**: businesses, churches, and homeowners are invited to "register" cameras or install a device that gives police **live streaming access** to them. The county's version of this network already includes ~1,500 cameras inside schools.

Fusus markets this as "one pane of glass": everything, one screen, live.

## What it costs

- **$1.14 million** in federal money (an earmark Rep. [[Chuck Edwards]] secured after city staff requested it in 2024; council was not informed, [[Records Center|request 14]]), covering the video wall (~$400K) and buildout
...
- Ongoing operational costs (~$250K), plus renewal pricing not yet set. At the [[2026-05-12 City Council|May 12]] hearing, a resident who negotiates contracts professionally noted Axon publishes its terms and customers "sign what is on the page"; another documented Axon's ~25%-per-year price escalation pattern, which Axon itself calls its "Flywheel of Growth."

## What it can do

Data from Asheville's plate readers was shared with law enforcement agencies within a **500-mile, multi-state radius** until August 2026, when APD narrowed sharing to Tennessee, South Carolina, Virginia, and Georgia (the chief's Aug 14, 2026 memo). Retention is set at 30 days in APD's policy (state law allows 90); Flock's own [portal for APD](https://transparency.flocksafety.com/asheville-nc-pd) showed 21 days on August 21, 2026, and the chief's [August 14 memo](https://docs.google.com/document/d/13kwmbwt6T9PiEjUgrFNb9ZHFGzaIsHi5cvsBHkpq-lY/edit) confirms the cut to 21 days, a cut in authorized searchers from 18 to 12, and sharing narrowed to Tennessee, South Carolina, Virginia, and Georgia. The same memo counts 86 Flock cameras in Buncombe County, 11 of them the city's, and says APD is evaluating "consolidating the BCSO RTIC into the APD RTIC," which would fold the [[WNC/Buncombe County/index|county's network]] into this one. The county's plate readers, which APD also reaches, have no retention number shorter than the statute's 90 ([[WNC/Buncombe County/index|Buncombe County]]).
...
Our concern is accountability and oversight, not cameras as such; the position is stated in full on the [[index|homepage]]. The RTIC was approved late in the May 12, 2026 meeting without the executed contract on the table, and each safeguard attached to it is a department policy.
