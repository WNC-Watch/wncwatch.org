---
title: Drew Ball
description: "Buncombe County Commissioner since December 2024, running for Asheville City Council on November 3, 2026. First statement on the cameras Sept 16, 2026, at a West Asheville candidate forum: wants audit logs, locally controlled data not fed to a national network, and closed-loop systems; credits Flock in the paintball case."
aliases:
  - "People/Drew Ball"
...
- "We need to make sure we control our data so it's not fed to a national network. We need closed loop systems that we control." (candidate forum, Sept 16, 2026, 10:09)
- "I don't trust the Trump administration or ICE." (same, 10:22)
...
He sits on the county body that funds the Fusus network and has not said whether the "closed loop systems that we control" he described include it. Would he vote for a surveillance-oversight ordinance, and for a council vote before the fixed Axon readers already under contract go in ([[Promise Tracker]])? See [[Election 2026]] for the questions to ask.
