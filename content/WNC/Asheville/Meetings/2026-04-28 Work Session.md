...
aliases:
  - "Meetings/Asheville/2026-04-28 Work Session"
...
## Security: the vendor on breaches [(1:42:09)](https://www.youtube.com/live/7tmfAjpPocA?t=6129)

Stated twice by the vendor side after questions about the reported camera exposures, which were described as device-level misconfiguration.

**The record:** the "cloud" qualifier is what makes the sentence technically true. Around the "cloud," the documented security failures stack: researchers **rooted a Flock camera in under 30 seconds**; ~70 Flock cameras were found **streaming unauthenticated on the open internet**; Senator Wyden and Rep. Krishnamoorthi asked the **FTC to investigate**, citing no mandatory two-factor authentication and **at least 35 cases of stolen Flock customer passwords**; stolen credentials get into the "never-breached" cloud without any breach. ([[Communities That Ended or Limited Contracts|Communities that ended or limited camera contracts]]) Narrow denials delivered as blanket assurance are precisely the pattern that got Flock terminated in Sedona ("misled and lied to") and rescinded in Oshkosh within 48 hours ([[Communities That Ended or Limited Contracts|Communities that ended or limited camera contracts]]).

## The immigration filter [(1:46:20)](https://www.youtube.com/live/7tmfAjpPocA?t=6380)
...
## Retention [(1:39:53)](https://www.youtube.com/live/7tmfAjpPocA?t=5993)
