...
On March 26, 2026 the committee advanced the RTIC grant to full council, 2 to 0. Every other committee meeting in 2025 and 2026 was streamed and archived; this one has no published recording. Its trace in the public record is the approval of its minutes at the next meeting, 3 to 0, without discussion. The minutes are a standing [[Records Center|records request]].

## November 20, 2025

Eight callers asked the committee to cancel the Flock and Fusus contracts over immigration-enforcement concerns; one asked the committee to "disable any city-owned Flock or Fusus camera and pause any data sharing agreement so that proper oversight and further review can be put in place."

[[Antanette Mosley|Mosley]] asked whether the city has agreements with ICE. Chief Lamb answered "No... we do not share any of our data with any federal agencies," adding that Flock and Axon "don't have the right to share our data either." The city attorney added that LPR use is "limited to only active criminal investigations, which is specifically exempt from public records." [[Sheneika Smith|Smith]] asked one follow-up. No member asked for the data-sharing agency list, no member asked for an audit, and no motion was made.

Two later records bear on those answers. In 2025 Flock's own customers learned of federal pilots giving Customs and Border Protection access to their cameras ([[Camera Network Misuse|Camera network misuse, documented cases]]). On April 28, 2026, [[Kim Roney|Roney]] read the Flock contract's "irrevocable, worldwide license" clause into the record at the [[2026-04-28 Work Session|work session]].

## The recorded meetings

- **May 29, 2025**: orientation. Staff describe the coming technology work, including the planned real-time center. A caller notes the Citizens Police Advisory Committee has been dormant since 2020 and asks the committee to restart it; the item did not return to a later agenda through July 2026.
- **July 31, 2025**: APD presents its technology plans (a new technology division, a future RTIC, "actively seeking grant opportunities" for Fusus). A caller asks: "what is the audit process? what is the transparency process? Why does the community have to come ask these questions?" The questions were not taken up. [[Sheneika Smith|Smith]]: "if the technology can scan, capture, and read a license plate, it can probably scan, capture, and read my face... What's the difference?"
- **September 25, 2025**: no public comment; no surveillance items.
- **January 29, 2026**: the last recorded meeting before the RTIC grant vote; the grant was not previewed. Smith to APD: "It's a fine line between proactivity and profiling. How do you all keep it clean?"
